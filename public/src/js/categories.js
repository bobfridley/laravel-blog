...
// add event listener to 1st button (create category)
...
function ajax(method, url, params, callback, callbackParams) {
    ...
    // true indicate ajax
    // headers tell Laravel this is an ajax request
